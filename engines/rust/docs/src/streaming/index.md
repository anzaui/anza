...
Server-Sent Events (SSE) and WebSockets allow servers to push live component fragment updates directly into client shadow roots.

## 1. Streaming Lifecycle

```
  Client (EventSource / WS)                 Rust Server (Anza Engine)
            │                                           │
